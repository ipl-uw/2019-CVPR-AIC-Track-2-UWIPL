...
class Options():
    def __init__(self):
        ...
        self.parser.add_argument('--model', required=True, default='LightenB', help='model type. [Alexnet | LightenB | VGG16 | Resnet18 | ...]')
        ...
        self.parser.add_argument('--ratio', type=str, default='[1, 0, 0]', help='ratio of whole dataset for Train, Validate, Test resperctively')
        ...
        self.parser.add_argument('--crop', type=str, default='NoCrop', help='crop type, candidates are [NoCrop | RandomCrop | CenterCrop | FiveCrop | TenCrop]')
        ...
        self.parser.add_argument('--mean', type=str, default='(0.485, 0.456, 0.406)', help='sequence of means for each channel used for normization')
        self.parser.add_argument('--std', type=str, default='(0.229, 0.224, 0.225)', help='sequence standard deviations for each channel used for normization')
        ...
        self.parser.add_argument('--checkpoint_name', type=str, default='_YOUR_MODEL_PATH_', help='path to pretrained model or model to deploy')
        ...
        self.parser.add_argument('--save_epoch_freq', type=int, default=10, help='save snapshot every $save_epoch_freq epoches training')
        self.parser.add_argument('--save_batch_iter_freq', type=int, default=2000, help='save snapshot every $save_batch_iter_freq training') 
        self.parser.add_argument('--lr', type=float, default=0.00001, help='initial learning rate')
        ...
        self.parser.add_argument('--weight_decay', type=float, default=1e-5, help='lr')
        ...
        ## for test
        self.parser.add_argument('--top_k', type=str, default='(3,)', help='tuple. We only take top k classification results into accuracy consideration')
    ...
    def parse(self):
        ...
        # mode
        if opt.mode not in ["Train", "Test", "Test-Train", "train", "test","test-train"]:
