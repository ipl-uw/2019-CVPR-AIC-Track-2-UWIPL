...
conversions = [
#    ('./track2-gallery-query-metadata-0507/test-prob-0.51.log',
#     './track2-gallery-query-metadata-0507/prob_v2m0.51.txt',
#     './track2-gallery-query-metadata-0507/imglist_v2m0.51.txt'),
#
#    ('./track2-gallery-query-metadata-0507/test-prob-0.70.log',
#     './track2-gallery-query-metadata-0507/prob_v2m0.70.txt',
#     './track2-gallery-query-metadata-0507/imglist_v2m0.70.txt'),
#
#    ('./track2-gallery-query-metadata-0507/test-prob-0.85.log',
#     './track2-gallery-query-metadata-0507/prob_v2m0.85.txt',
#     './track2-gallery-query-metadata-0507/imglist_v2m0.85.txt'),
#
...
#     './track2-gallery-query-metadata-0507/imglist_v2m100.txt'),
    ...
    ('./track2-prob-pred-cm-0529/prob_Epoch2.log',
     './track2-prob-pred-cm-0529/prob_v2e2.txt',
     './track2-prob-pred-cm-0529/imglist_v2e2.txt'),

    ('./track2-prob-pred-cm-0529/prob_Epoch3.log',
     './track2-prob-pred-cm-0529/prob_v2e3.txt',
     './track2-prob-pred-cm-0529/imglist_v2e3.txt'),

    ('./track2-prob-pred-cm-0529/prob_Epoch4.log',
     './track2-prob-pred-cm-0529/prob_v2e4.txt',
     './track2-prob-pred-cm-0529/imglist_v2e4.txt'),

    ('./track2-prob-pred-cm-0529/prob_Epoch5.log',
     './track2-prob-pred-cm-0529/prob_v2e5.txt',
     './track2-prob-pred-cm-0529/imglist_v2e5.txt'),

    ('./track2-prob-pred-cm-0529/prob_Epoch8.log',
     './track2-prob-pred-cm-0529/prob_v2e8.txt',
     './track2-prob-pred-cm-0529/imglist_v2e8.txt'),

    ('./track2-prob-pred-cm-0529/prob_Epoch10.log',
     './track2-prob-pred-cm-0529/prob_v2e10.txt',
     './track2-prob-pred-cm-0529/imglist_v2e10.txt'),
